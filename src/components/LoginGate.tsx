            ...
            <div>
              ...
              <div className="p-6">
                ...
                {!showSimulatedFallback ? (
                  /* Standard Google Pop-up - Direct simple layout */
                  <div className="space-y-4 py-4 text-center">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-3 px-5 py-3.5 bg-white hover:bg-slate-50 active:bg-slate-100 text-[#1e293b] font-extrabold text-xs uppercase tracking-wider rounded-xl border border-slate-250 shadow-md hover:shadow-lg transition-all duration-155 transform active:translate-y-px cursor-pointer"
                    >
                    ...
                    <div className="pt-4 border-t border-slate-800/50 mt-4 text-center">
                      <button
                        ...
                        className="text-[10px] text-slate-550 hover:text-sky-400 underline font-mono cursor-pointer transition-colors"
                      >
                        Gunakan Akun Simulasi (Bypass Sandbox Mode)
                      </button>
                    </div>
                  </div>
                ) : (
                  /* Fallback Beautiful Simulator UI - Only displayed if manually requested or authentication fails */
                  <div className="space-y-4">
                    <div className="p-3 bg-amber-500/10 border border-amber-500/20 text-amber-400 rounded-xl text-xs space-y-2 text-left">
                      ...
                      <div className="bg-slate-950/80 p-2 rounded-lg flex items-center justify-between border border-slate-800 font-mono text-[9px]">
                        ...
                        <button
                          ...
                          className="ml-2 shrink-0 px-2 py-0.5 bg-slate-800 hover:bg-slate-700 active:bg-slate-600 rounded text-[9px] font-bold text-white transition"
                        >
                    ...
                    <div className="space-y-3">
                      <p className="text-[11px] text-slate-400 leading-normal text-left animate-pulse">
                        Mode Simulasi Aktif. Silakan pilih akun di bawah ini:
                      </p>
                        ...
                        <form onSubmit={handleCustomSimulatedSubmit} className="space-y-2">
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-9 pr-3 py-1.5 text-xs rounded-lg border border-slate-800 bg-slate-950 text-white placeholder-slate-650 focus:outline-none focus:ring-1 focus:ring-sky-500"
                            />
                          </div>
                          <div className="relative">
                      ...
                      <div className="pt-2 text-center">
                        <button
                          ...
                          className="text-[10px] text-sky-400 hover:text-sky-305 underline font-mono cursor-pointer transition-colors"
                        >
                          Kembali Ke Google Auth Resmi
                        </button>
                      </div>
                    </div>
                  </div>
