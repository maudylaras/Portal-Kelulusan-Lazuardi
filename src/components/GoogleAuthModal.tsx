                ...
                <div className="space-y-4 py-4 text-center">
                  ...
                  <div className="pt-4 border-t border-slate-100 mt-4 text-center">
                    <button
                      ...
                      className="text-[10px] text-slate-405 hover:text-sky-600 underline font-mono cursor-pointer transition-colors"
                    >
                      Bypass / Sandbox Demo Mode
                    </button>
                  </div>
                </div>
              ) : (
                  ...
                  <div className="p-3 bg-amber-50 border border-amber-200 text-amber-800 rounded-xl text-xs space-y-1.5 text-left">
                    ...
                    <div className="bg-slate-50 p-2 rounded flex items-center justify-between border border-slate-200 font-mono text-[9px] text-slate-700">
                      ...
                      <button
                        ...
                        className="shrink-0 ml-1.5 px-1.5 py-0.5 bg-slate-200 hover:bg-slate-300 rounded text-[9px] font-bold text-slate-800 transition"
                      >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="pt-2 text-center">
                      <button
                        ...
                        className="text-[10px] text-sky-600 hover:text-sky-700 underline font-mono cursor-pointer transition-colors"
                      >
